...
from .views import (
    ContatoApiView, InscricaoApiView, PagamentoApiView, DependenteApiView, ConferenciaApiView, DependentesApiView,
    RelatorioIdadesApiView, RelatorioCidadesApiView, RelatorioHospedagemApiView, InscricaoStatusPagSeguroApiView,
